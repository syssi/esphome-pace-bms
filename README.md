...
* BSL Batt rack mount 51.2V 100Ahmodels B_LFP_48_100E_3U firmware version 1.51 (may work with other versions as well)  using RS485 protocol `PACE_MODBUS`
* BSL Batt rack mount 51.2V 125Ah B-LFP51V-125Ah firmware version 1.51 (may work with other versions as well)  using RS485 protocol `PACE_MODBUS`
* BSL Batt rack mount 51.2V 135Ah B-LFP48-135E-7kw  firmware version 1.51 (may work with other versions as well)  using RS485 protocol `PACE_MODBUS` 
